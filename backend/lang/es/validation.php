...
return [
    ...
    'attributes' => [
        ...
        'national_id_type' => 'tipo de documento',
        'birth_date' => 'fecha de nacimiento',
        'health_insurance' => 'prevision de salud',
        'primary_health_center' => 'centro de salud familiar',
        'allergies' => 'alergias',
        'health_conditions' => 'condiciones de salud',
        'communication_preference' => 'preferencia de comunicacion',
        'relationship' => 'parentesco',
        'organization_id' => 'organizacion',
        'health_center_id' => 'centro de salud',
        'unit_id' => 'unidad',
        'patient_id' => 'paciente',
        'address'                  => 'dirección',
